...
const TableList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      valueType: 'option',
      render: (_, record) => [
        <DeleteButton key="delete" record={record} elementId="blog-list-delete-btn" />,
      ],
    },
  ];
  const DeleteButton = (props) => {
    ...
    const showDeleteConfirm = (user) => {
      confirm({
        ...
        content: `Blog will be deleted permanently.`,
        okText: 'Yes',
        okType: 'danger',
        cancelText: 'No',
        onOk: async () => {
          ...
          <Row gutter={2}>
            <Col flex={1} key={'name'}>
              <Form.Item style={{ marginBottom: 0 }} name={`name`}>
                <Input size="" placeholder="Search keyword " width={'500px'} />
              </Form.Item>
            </Col>
            <Col flex={6}>
