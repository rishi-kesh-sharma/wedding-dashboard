  ...
  return (
    permission && (
      <PageContainer pageHeaderRender={false}>
        <Card className="Permission Update Form" bordered={false}>
          <ProForm
            ...
            <ProFormSelect
              ...
              onChange={(value, e) =>
                setResource({
                  ...
                  resourceAlias: e.resource.alias,
                })
              }
            />
            <ProFormCheckbox name="isAllowed">Is allowed</ProFormCheckbox>
            <ProFormCheckbox name="isDisabled">Is disabled</ProFormCheckbox>
          </ProForm>
        </Card>
      </PageContainer>
    )
