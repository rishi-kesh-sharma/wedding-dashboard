...
const EntryForm = (props) => {
  ...
  return (
    <PageContainer pageHeaderRender={false}>
      <Card title="Product Entry Form" bordered={false}>
        <ProForm
          hideRequiredMark
          style={{
            margin: 'auto',
        ...
        >
          ...
          <ProFormRadio.Group
            ...
            name="size"
          />
          <ProFormDatePicker width="lg" name="manufacturingDate" label="Manufacturing date" />
          <ProFormDatePicker width="lg" name="expiryDate" label="Expiry date" />
        </ProForm>
      </Card>
    </PageContainer>
  );
